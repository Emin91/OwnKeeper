...
export const TabNavigator: FC = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <Tab.Navigator swipeEnabled={false} tabBarPosition="bottom" sceneContainerStyle={{backgroundColor: "transparent"}} initialRouteName="DataTabView" tabBar={(props) => <CustomTabBar {...props} />}>
